                ...
                >
                    <div
                        className={cn(
                            "glow",
                            "rounded-[inherit]",
                            'after:content-[""] after:rounded-[inherit] after:absolute after:inset-[calc(-1*var(--glowingeffect-border-width))] after:border-[length:var(--glowingeffect-border-width)] after:border-transparent after:bg-[linear-gradient(var(--start),var(--gradient))] after:bg-border-box after:bg-origin-border after:[mask:linear-gradient(#000,#000),linear-gradient(#000,#000)] after:[mask-clip:content-box,border-box] after:[mask-composite:exclude]'
                        )}
                        style={{
